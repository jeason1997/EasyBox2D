...
(function () {
   ...
   b2DebugDraw.prototype.DrawPolygon = function (vertices, vertexCount, color) {
      ...
      for (var i = 0; i < vertexCount; i++) {
         verts[i] = new b2Vec2(vertices[i].x * drawScale, vertices[i].y * drawScale);
      }
      
      s.drawPoly(verts, new cc.Color(0, 0, 0, 0), 
        this.m_lineThickness * 2, new cc.Color(color._r, color._g, color._b, this.m_alpha * 255));
   };
   b2DebugDraw.prototype.DrawSolidPolygon = function (vertices, vertexCount, color) {
      if (!vertexCount) return;
      var s = this.m_ctx;
      ...
      s.drawPoly(verts, new cc.Color(color._r, color._g, color._b, this.m_fillAlpha * 255), 
        this.m_lineThickness * 2, new cc.Color(color._r, color._g, color._b, this.m_alpha * 255));
   };
   b2DebugDraw.prototype.DrawCircle = function (center, radius, color) {
      if (!radius) return;
      ...
      s.drawCircle(new b2Vec2(center.x * drawScale, center.y * drawScale), 
        radius * drawScale, 0, 20, true, this.m_lineThickness * 2, new cc.Color(color._r, color._g, color._b, this.m_alpha * 255));
   };
   b2DebugDraw.prototype.DrawSolidCircle = function (center, radius, axis, color) {
      if (!radius) return;
      var s = this.m_ctx;
      ...
      s.drawDot(new b2Vec2(center.x * drawScale, center.y * drawScale),
        radius * drawScale, new cc.Color(color._r, color._g, color._b, this.m_fillAlpha * 255));
      
      s.drawCircle(new b2Vec2(center.x * drawScale, center.y * drawScale), 
        radius * drawScale, 0, 20, false, this.m_lineThickness * 2, new cc.Color(color._r, color._g, color._b, this.m_alpha * 255));
   };
   b2DebugDraw.prototype.DrawSegment = function (p1, p2, color) {
      var s = this.m_ctx,
         drawScale = this.m_drawScale;
      var from = new b2Vec2(p1.x * drawScale, p1.y * drawScale);
      var to = new b2Vec2(p2.x * drawScale, p2.y * drawScale);
      s.drawSegment(from, to, this.m_lineThickness, new cc.Color(color._r, color._g, color._b, this.m_alpha * 255));
   };
   b2DebugDraw.prototype.DrawTransform = function (xf) {
      var s = this.m_ctx,
         drawScale = this.m_drawScale;
      ...
      s.drawSegment(
          new b2Vec2(xf.position.x * drawScale, xf.position.y * drawScale),
          new b2Vec2((xf.position.x + this.m_xformScale * xf.R.col1.x) * drawScale, (xf.position.y + this.m_xformScale * xf.R.col1.y) * drawScale), 
          this.m_lineThickness, 
          new cc.Color(255, 0, 0, this.m_alpha * 255));
      
      s.drawSegment(
          new b2Vec2(xf.position.x * drawScale, xf.position.y * drawScale), 
          new b2Vec2((xf.position.x + this.m_xformScale * xf.R.col2.x) * drawScale, (xf.position.y + this.m_xformScale * xf.R.col2.y) * drawScale), 
          this.m_lineThickness, 
          new cc.Color(0, 255, 0, this.m_alpha * 255));
   };
})(); //post-definitions
var i;
...
exports.b2DistanceJointDef = Box2D.Dynamics.Joints.b2DistanceJointDef;
...
exports.b2FilterData = Box2D.Dynamics.b2FilterData;
exports.b2EdgeShape = Box2D.Collision.Shapes.b2EdgeShape;
exports.b2LineJointDef = Box2D.Dynamics.Joints.b2LineJointDef;
exports.b2WeldJointDef = Box2D.Dynamics.Joints.b2WeldJointDef;
exports.b2GearJointDef = Box2D.Dynamics.Joints.b2GearJointDef;
exports.b2PrismaticJointDef = Box2D.Dynamics.Joints.b2PrismaticJointDef;
exports.b2FrictionJointDef = Box2D.Dynamics.Joints.b2FrictionJointDef;
exports.b2PulleyJointDef = Box2D.Dynamics.Joints.b2PulleyJointDef;
exports.b2RopeJointDef = Box2D.Dynamics.Joints.b2RopeJointDef;
