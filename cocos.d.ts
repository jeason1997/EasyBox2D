...
declare module cc {	
	...
	export class Action extends _Class {		
	...
	export class ActionManager extends _Class {		
	...
	export class Scheduler extends _Class {		
		/** <p>
	...
	export class EventListener extends _Class {		
	...
	export class Touch extends _Class {		
    ...
    */
	export function Class(obj: {name?: string, extends? : Function, properties: any}): Function;
	...
	export class view extends _Class {		
		/** <p>
	...
	export class ContainerStrategy extends _Class {		
	...
	export class ContentStrategy extends _Class {		
	...
	export class ResolutionPolicy extends _Class {		
	...
	export class TextureAtlas extends _Class {		
		constructor();		
